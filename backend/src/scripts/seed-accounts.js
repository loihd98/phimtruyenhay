...
const PERMISSIONS = [
  // Story Text
  {
    code: "story_text.view",
    name: "Xem truyện text",
    group: "story_text",
    type: "view",
    description: "Xem danh sách và chi tiết truyện text",
  },
  {
    code: "story_text.create",
    name: "Tạo truyện text",
    group: "story_text",
    type: "action",
    description: "Tạo truyện text mới",
  },
  {
    code: "story_text.update",
    name: "Sửa truyện text",
    group: "story_text",
    type: "action",
    description: "Chỉnh sửa truyện text",
  },
  {
    code: "story_text.delete",
    name: "Xóa truyện text",
    group: "story_text",
    type: "action",
    description: "Xóa truyện text",
  },
  // Story Audio
  {
    code: "story_audio.view",
    name: "Xem truyện audio",
    group: "story_audio",
    type: "view",
    description: "Xem danh sách và chi tiết truyện audio",
  },
  {
    code: "story_audio.create",
    name: "Tạo truyện audio",
    group: "story_audio",
    type: "action",
    description: "Tạo truyện audio mới",
  },
  {
    code: "story_audio.update",
    name: "Sửa truyện audio",
    group: "story_audio",
    type: "action",
    description: "Chỉnh sửa truyện audio",
  },
  {
    code: "story_audio.delete",
    name: "Xóa truyện audio",
    group: "story_audio",
    type: "action",
    description: "Xóa truyện audio",
  },
  // Film
  {
    code: "film.view",
    ...
    group: "film",
    type: "view",
    description: "Xem danh sách và chi tiết phim",
  },
  {
    code: "film.create",
    name: "Tạo phim",
    group: "film",
    type: "action",
    description: "Tạo bài review phim mới",
  },
  {
    code: "film.update",
    name: "Sửa phim",
    group: "film",
    type: "action",
    description: "Chỉnh sửa bài review phim",
  },
  {
    code: "film.delete",
    name: "Xóa phim",
    group: "film",
    type: "action",
    description: "Xóa bài review phim",
  },
  // User
  {
    code: "user.view",
  ...
  // Admin
  {
    ...
    group: "admin",
    type: "view",
    description: "Quyền truy cập trang admin",
  },
  {
    ...
    group: "admin",
    type: "view",
    description: "Xem trang tổng quan admin",
  },
  // Media
  {
    code: "media.view",
  ...
  },
  {
    ...
    group: "media",
    type: "action",
    description: "Upload file media mới",
  },
  {
    code: "media.delete",
    name: "Xóa media",
  ...
  // Blog
  {
    ...
    group: "blog",
    type: "view",
    description: "Xem tất cả bài blog",
  },
  {
    code: "blog.create",
    name: "Viết blog",
  ...
  },
  {
    ...
    group: "blog",
    type: "action",
    description: "Chỉnh sửa bài blog",
  },
  {
    code: "blog.delete",
    name: "Xóa blog",
  ...
  {
    code: "blog.category.create",
    name: "Thêm danh mục blog",
    group: "blog",
    type: "action",
    description: "Thêm danh mục blog mới",
  },
  {
    code: "blog.category.update",
    name: "Sửa danh mục blog",
    group: "blog",
    type: "action",
    description: "Sửa danh mục blog",
  },
  {
    code: "blog.category.delete",
    name: "Xóa danh mục blog",
    group: "blog",
    type: "action",
    description: "Xóa danh mục blog",
  },
];
