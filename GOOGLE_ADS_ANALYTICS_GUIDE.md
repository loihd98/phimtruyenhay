...
4. Nhập tên: `The Midnight Movie Reel`
...
2. Nhập URL: `https://themidnightmoviereel.io.vn`
...
2. Click **Get Started**
3. Nhập URL website: `https://themidnightmoviereel.io.vn`
...
2. Thêm property: `https://themidnightmoviereel.io.vn`
...
- **NEXT_PUBLIC_** prefix là bắt buộc cho biến frontend (Next.js exposes to browser)
