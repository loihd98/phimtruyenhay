# Tổng Quan Kiến Trúc & Công Nghệ Dự Án themidnightmoviereel.io.vn

## 1. Tổng Quan Dự Án

**themidnightmoviereel.io.vn** là một nền tảng full-stack cho phép đọc truyện online, nghe truyện audio và review phim. Dự án được containerize hoàn toàn bằng Docker, triển khai trên VPS Ubuntu với Nginx reverse proxy và SSL.
...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  return {
    title: `${data.title} | themidnightmoviereel.io.vn`,
...
| `DOMAIN`              | Domain name                        | `themidnightmoviereel.io.vn`                            |
...
```
1. User truy cập https://themidnightmoviereel.io.vn/stories/dau-pha-thuong-khung
