# Tổng Quan Kiến Trúc & Công Nghệ Dự Án phimtruyenhay.com

## 1. Tổng Quan Dự Án

**phimtruyenhay.com** là một nền tảng full-stack cho phép đọc truyện online, nghe truyện audio và review phim. Dự án được containerize hoàn toàn bằng Docker, triển khai trên VPS Ubuntu với Nginx reverse proxy và SSL.
...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  return {
    title: `${data.title} | phimtruyenhay.com`,
...
| `DOMAIN`              | Domain name                        | `phimtruyenhay.com`                       |
...
```
1. User truy cập https://phimtruyenhay.com/stories/dau-pha-thuong-khung
