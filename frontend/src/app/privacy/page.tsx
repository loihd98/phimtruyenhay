    ...
    <Layout>
      <div className="max-w-[1400px] mx-auto px-4 lg:px-8 py-8">
        ...
        <div className="max-w-4xl mx-auto">
          {/* Privacy Summary */}
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 mb-8 animate-slide-up animation-delay-300">
          ...
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-8 mb-8 animate-slide-up animation-delay-400">
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gray-50 bg-white/[0.04] p-4 rounded-2xl">
              ...
              <div className="bg-primary-500/10 p-6 rounded-2xl mb-6">
          ...
          {/* Data Request */}
          <div className="bg-primary-500/10 border border-primary-500/20 rounded-2xl p-6 animate-slide-up animation-delay-500">
            <h3 className="text-lg font-bold text-primary-400  mb-3 flex items-center">
              <span className="mr-2">📋</span>Yêu cầu dữ liệu cá nhân
            </h3>
            <p className="text-primary-400  text-sm leading-relaxed mb-3">
