  ...
  return (
    <div>
      ...
      <div className="hidden sm:block relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_30%,_rgba(229,9,20,0.08),_transparent_40%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_70%,_rgba(124,58,237,0.06),_transparent_40%)]" />
        {/* Grid pattern */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-primary-500/10 border border-primary-500/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-[12px] font-medium text-primary-400 tracking-wide uppercase">Review & Analysis</span>
              </div>

              <h1 className="text-4xl lg:text-[3.5rem] font-bold leading-[1.1] mb-6">
                <span className="text-white">Khám phá thế giới</span>
                <br />
                <span className="bg-gradient-to-r from-primary-500 via-accent-500 to-cinema-purple bg-clip-text text-transparent">điện ảnh cùng bạn</span>
              </h1>

              <p className="text-base text-zinc-500 mb-8 max-w-lg leading-relaxed">
                Review chi tiết, phân tích cốt truyện, giải thích ending — từ Hollywood blockbuster đến indie gems. Không spoiler, không lan man.
              </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="group bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 hover:border-primary-500/30 hover:bg-primary-500/[0.03] transition-all duration-300">
                ...
                <h3 className="text-white font-semibold text-sm mb-1">Review Chi Tiết</h3>
                <p className="text-zinc-600 text-xs leading-relaxed">Cốt truyện, diễn xuất, hình ảnh & âm thanh</p>
              </div>
              <div className="group bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 hover:border-accent-500/30 hover:bg-accent-500/[0.03] transition-all duration-300">
                ...
                <h3 className="text-white font-semibold text-sm mb-1">Giải Thích Ending</h3>
                <p className="text-zinc-600 text-xs leading-relaxed">Twist, ẩn ý và kết thúc mở</p>
              </div>
              <div className="group bg-white/[0.02] border border-white/[0.06] rounded-2xl p-5 hover:border-cinema-purple/30 hover:bg-cinema-purple/[0.03] transition-all duration-300">
                ...
                <h3 className="text-white font-semibold text-sm mb-1">Top Phim Hay</h3>
                <p className="text-zinc-600 text-xs leading-relaxed">Gợi ý theo chủ đề & thể loại</p>
              </div>
      ...
      <div className="sm:hidden px-4 pt-4 pb-2">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0e0e18] to-[#12081e] border border-white/[0.06] p-5">
          <div className="absolute top-0 right-0 w-40 h-40 bg-primary-500/8 blur-[80px] rounded-full" />
          <div className="inline-flex items-center gap-1.5 bg-primary-500/10 border border-primary-500/20 rounded-full px-3 py-1 mb-3">
            ...
            <span className="text-[10px] font-medium text-primary-400 uppercase tracking-wider">Review & Analysis</span>
          </div>
          <h1 className="text-xl font-bold text-white mb-1.5 leading-tight">
            Khám phá thế giới <span className="text-primary-500">điện ảnh</span>
          </h1>
          <p className="text-xs text-zinc-500 mb-4">Review chi tiết, phân tích cốt truyện, giải thích ending</p>
